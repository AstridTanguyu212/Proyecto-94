...
function my_keydown(e)
{
    ...
    if((ball_x==hole_x)&&(ball_y==hole_y)){
		...
		document.getElementById("hd3").innerHTML = "La pelota entró en el hoyo";
	...
	function left()
	{
		if(ball_x >=5)
		{
			...
			console.log("Cuando se presione la flecha hacia izquierda, X= " + ball_x + " | Y= " + ball_y);
            canvas.remove(ball_obj);
			new_image();
		}
	}
	...
	function right()
	{
		if(ball_x <=1050)
		{
			ball_x = ball_x + block_image_width;
			console.log("ancho de la imagen = " + block_image_width);
			console.log("Cuando se presione la flecha hacia derecha, X= " + ball_x + " | Y= " + ball_y);
            canvas.remove(ball_obj);
			new_image();
		}
	}
